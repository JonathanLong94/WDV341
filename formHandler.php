...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inResidency = $_POST["residency"];
	$inTransport = $_POST["transportation"];
...
<p>Type of Residency: <?php echo $inResidency; ?></p>
<p>Method of Transportation: <?php echo $inTransport; ?></p>
